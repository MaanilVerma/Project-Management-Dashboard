    ...
    (function(global2, factory) {
        ...
        clone: function() {
          ...
          for (var prop in source) {
            if (source.hasOwnProperty(prop)) {
              value = source[prop];
              type2 = {}.toString.call(value);
              if (type2 === "[object Array]") {
                target[prop] = value.slice(0);
              } else if (type2 === "[object Number]") {
                target[prop] = value;
              } else {
      ...
      var helpers = {
        ...
        isArray: function(value) {
          ...
          if (type2.substr(0, 7) === "[object" && type2.substr(-6) === "Array]") {
            return true;
          }
          return false;
        },
      ...
      var exports$1 = {
        ...
        drawPoint: function(ctx, style, radius, x, y, rotation) {
          var type2, xOffset, yOffset, size, cornerRadius;
      ...
      function interpolate(start, view, model, ease) {
        ...
        var i, ilen, key, actual, origin, target, type2, c0, c1;
      ...
      helpers$1.extend(DatasetController.prototype, {
        ...
        createMetaDataset: function() {
          var me = this;
          var type2 = me.datasetElementType;
          return type2 && new type2({
            _chart: me.chart,
      ...
      function removeListener(node, type2, listener) {
        node.removeEventListener(type2, listener, eventListenerOptions);
      }
      function createEvent(type2, chart, x, y, nativeEvent) {
        return {
          type: type2,
          chart,
      ...
      function fromNativeEvent(event, chart) {
        var type2 = EVENT_TYPES[event.type] || event.type;
        var pos = helpers$1.getRelativePosition(event, chart);
        return createEvent(type2, chart, pos.x, pos.y, event);
      }
      ...
      function watchForRender(node, handler) {
        ...
        helpers$1.each(ANIMATION_START_EVENTS, function(type2) {
          addListener(node, type2, proxy);
        });
      ...
      function unwatchForRender(node) {
        ...
        if (proxy) {
          helpers$1.each(ANIMATION_START_EVENTS, function(type2) {
            removeListener(node, type2, proxy);
          });
      ...
      var platform_dom$2 = {
        ...
        addEventListener: function(chart, type2, listener) {
          var canvas2 = chart.canvas;
          if (type2 === "resize") {
          ...
          var proxy = proxies[chart.id + "_" + type2] = function(event) {
            listener(fromNativeEvent(event, chart));
          };
          addListener(canvas2, type2, proxy);
        },
        removeEventListener: function(chart, type2, listener) {
          var canvas2 = chart.canvas;
          if (type2 === "resize") {
          ...
          var proxy = proxies[chart.id + "_" + type2];
          if (!proxy) {
            return;
          }
          removeListener(canvas2, type2, proxy);
        }
      };
      ...
      var core_scaleService = {
        ...
        defaults: {},
        registerScaleType: function(type2, scaleConstructor, scaleDefaults) {
          this.constructors[type2] = scaleConstructor;
          this.defaults[type2] = helpers$1.clone(scaleDefaults);
        },
        getScaleConstructor: function(type2) {
          return this.constructors.hasOwnProperty(type2) ? this.constructors[type2] : void 0;
        },
        getScaleDefaults: function(type2) {
          return this.defaults.hasOwnProperty(type2) ? helpers$1.merge({}, [core_defaults.scale, this.defaults[type2]]) : {};
        },
        updateScaleDefaults: function(type2, additions) {
          var me = this;
          if (me.defaults.hasOwnProperty(type2)) {
            me.defaults[type2] = helpers$1.extend(me.defaults[type2], additions);
          }
        },
        ...
        return helpers$1.merge({}, [].slice.call(arguments), {
          merger: function(key, target, source, options2) {
            if (key === "xAxes" || key === "yAxes") {
              ...
              for (i = 0; i < slen; ++i) {
                scale2 = source[key][i];
                type2 = valueOrDefault$9(scale2.type, key === "xAxes" ? "category" : "linear");
                if (i >= target[key].length) {
                  target[key].push({});
                }
                if (!target[key][i].type || scale2.type && scale2.type !== target[key][i].type) {
                  helpers$1.merge(target[key][i], [core_scaleService.getScaleDefaults(type2), scale2]);
                } else {
        ...
        /** @lends Chart */
        {
          ...
          buildOrUpdateControllers: function() {
            ...
            for (i = 0, ilen = datasets.length; i < ilen; i++) {
              ...
              var type2 = dataset.type || me.config.type;
          ...
          */
          ...
          bindEvents: function() {
            ...
            helpers$1.each(me.options.events, function(type2) {
              platform.addEventListener(me, type2, listener);
          ...
          unbindEvents: function() {
            ...
            helpers$1.each(listeners, function(listener, type2) {
              platform.removeEventListener(me, type2, listener);
            });
          },
      ...
      var Scale = core_element.extend({
        ...
        */
         ...
         * @private
         */
        _getMatchingVisibleMetas: function(type2) {
          var me = this;
          var isHorizontal = me.isHorizontal();
          return me.chart._getSortedVisibleDatasetMetas().filter(function(meta) {
            return (!type2 || meta.type === type2) && (isHorizontal ? meta.xAxisID === me.id : meta.yAxisID === me.id);
          });
        }
      });
      ...
      var Legend = core_element.extend({
        ...
        handleEvent: function(e) {
          var me = this;
          var opts = me.options;
          var type2 = e.type === "mouseup" ? "click" : e.type;
          var hoveredItem;
          if (type2 === "mousemove") {
      ...
      core_controller.helpers.each(scales, function(scale2, type2) {
        core_controller.scaleService.registerScaleType(type2, scale2, scale2._defaults);
      });
...
var ChartComponent = function(_React$Component) {
  ...
  ChartComponent2.prototype.componentDidMount = function componentDidMount() {
    this.renderChart();
  };
  ChartComponent2.prototype.componentDidUpdate = function componentDidUpdate() {
  ...
  ChartComponent2.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    var _props = this.props, redraw = _props.redraw, type2 = _props.type, options = _props.options, plugins = _props.plugins, legend = _props.legend, height = _props.height, width = _props.width;
    ...
    if (type2 !== nextProps.type) {
      return true;
    }
    if (!(0, import_isEqual.default)(legend, nextProps.legend)) {
      return true;
    }
    if (!(0, import_isEqual.default)(options, nextProps.options)) {
      return true;
    }
    var nextData = this.transformDataProp(nextProps);
    if (!(0, import_isEqual.default)(this.shadowDataProp, nextData)) {
      return true;
    }
    return !(0, import_isEqual.default)(plugins, nextProps.plugins);
  };
  ChartComponent2.prototype.componentWillUnmount = function componentWillUnmount() {
    this.destroyChart();
  };
  ChartComponent2.prototype.transformDataProp = function transformDataProp(props) {
    var data = props.data;
  ...
  ChartComponent2.prototype.memoizeDataProps = function memoizeDataProps() {
    if (!this.props.data) {
      return;
    }
    ...
    this.shadowDataProp = _extends({}, data, {
      datasets: data.datasets && data.datasets.map(function(set2) {
        return _extends({}, set2);
      })
    });
    this.saveCurrentDatasets();
    return data;
  };
  ChartComponent2.prototype.checkDatasets = function checkDatasets(datasets) {
  ...
  ChartComponent2.prototype.getCurrentDatasets = function getCurrentDatasets() {
    return this.chartInstance && this.chartInstance.config.data && this.chartInstance.config.data.datasets || [];
  };
  ChartComponent2.prototype.saveCurrentDatasets = function saveCurrentDatasets() {
    var _this2 = this;
  ...
  ChartComponent2.prototype.updateChart = function updateChart() {
    var _this3 = this;
    ...
    if (!this.chartInstance)
      return;
    if (options) {
      this.chartInstance.options = import_chart.default.helpers.configMerge(this.chartInstance.options, options);
    }
    var currentDatasets = this.getCurrentDatasets();
    var nextDatasets = data.datasets || [];
    this.checkDatasets(currentDatasets);
    var currentDatasetsIndexed = (0, import_keyBy.default)(currentDatasets, this.props.datasetKeyProvider);
  ...
  ChartComponent2.prototype.renderChart = function renderChart() {
    var _props2 = this.props, options = _props2.options, legend = _props2.legend, type2 = _props2.type, plugins = _props2.plugins;
    var node = this.element;
    var data = this.memoizeDataProps();
    if (typeof legend !== "undefined" && !(0, import_isEqual.default)(ChartComponent2.defaultProps.legend, legend)) {
      options.legend = legend;
    }
    this.chartInstance = new import_chart.default(node, {
      type: type2,
      data,
      options,
      plugins
  ...
  ChartComponent2.prototype.destroyChart = function destroyChart() {
    if (!this.chartInstance) {
      return;
    }
    this.saveCurrentDatasets();
  ...
  ChartComponent2.prototype.render = function render() {
    var _props3 = this.props, height = _props3.height, width = _props3.width, id = _props3.id;
...
ChartComponent.propTypes = {
  data: import_prop_types.default.oneOfType([import_prop_types.default.object, import_prop_types.default.func]).isRequired,
  getDatasetAtEvent: import_prop_types.default.func,
  getElementAtEvent: import_prop_types.default.func,
  getElementsAtEvent: import_prop_types.default.func,
  height: import_prop_types.default.number,
  legend: import_prop_types.default.object,
  onElementsClick: import_prop_types.default.func,
  options: import_prop_types.default.object,
  plugins: import_prop_types.default.arrayOf(import_prop_types.default.object),
  redraw: import_prop_types.default.bool,
  type: function type(props, propName, componentName) {
    if (!import_chart.default.controllers[props[propName]]) {
      return new Error("Invalid chart type `" + props[propName] + "` supplied to `" + componentName + "`.");
    }
  },
  width: import_prop_types.default.number,
  datasetKeyProvider: import_prop_types.default.func
};
...
var Doughnut = function(_React$Component2) {
  ...
  Doughnut2.prototype.render = function render() {
    var _this5 = this;
    return import_react.default.createElement(ChartComponent, _extends({}, this.props, {
...
var Pie = function(_React$Component3) {
  ...
  Pie2.prototype.render = function render() {
    var _this7 = this;
    return import_react.default.createElement(ChartComponent, _extends({}, this.props, {
...
var HorizontalBar = function(_React$Component6) {
  ...
  HorizontalBar2.prototype.render = function render() {
    var _this13 = this;
    return import_react.default.createElement(ChartComponent, _extends({}, this.props, {
...
var Radar = function(_React$Component7) {
  ...
  Radar2.prototype.render = function render() {
    var _this15 = this;
    return import_react.default.createElement(ChartComponent, _extends({}, this.props, {
...
var Polar = function(_React$Component8) {
  ...
  Polar2.prototype.render = function render() {
    var _this17 = this;
    return import_react.default.createElement(ChartComponent, _extends({}, this.props, {
...
var Bubble = function(_React$Component9) {
  ...
  Bubble2.prototype.render = function render() {
    var _this19 = this;
    return import_react.default.createElement(ChartComponent, _extends({}, this.props, {
...
var Scatter = function(_React$Component10) {
  ...
  Scatter2.prototype.render = function render() {
    var _this21 = this;
    return import_react.default.createElement(ChartComponent, _extends({}, this.props, {
...
var defaults2 = import_chart.default.defaults;
